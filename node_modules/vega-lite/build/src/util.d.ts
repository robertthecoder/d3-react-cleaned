...
export declare function without<T>(array: readonly T[], excludedItems: readonly T[]): T[];
export declare function union<T>(array: readonly T[], other: readonly T[]): T[];
/**
...
export declare function logicalExpr<T>(op: LogicalOperand<T>, cb: (...args: readonly any[]) => string): string;
/**
 ...
 */
export declare function getFirstDefined<T>(...args: readonly T[]): T;
/**

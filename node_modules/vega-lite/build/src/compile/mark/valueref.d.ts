 ...
 */
export declare function vgValueRef(channel: Channel, value: ValueOrGradientOrText): {
    field: {
        group: string;
    };
    value?: undefined;
} | {
    value: ValueOrGradientOrText;
    field?: undefined;
};
...
export declare function text(channelDef: ChannelDefWithCondition<FieldDef<string>, Value | string[]>, config: Config, expr?: 'datum' | 'datum.datum'): VgValueRef;
